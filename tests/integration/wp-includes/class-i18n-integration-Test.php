...
namespace BH_WC_Zelle_Gateway\WP_Includes;

/**
 * Class BH_WC_Zelle_Gateway_Test
 *
 * @see I18n
 */
class I18n_Integration_Test extends \Codeception\TestCase\WPTestCase {
	...
	public function test_load_plugin_textdomain() {
		...
		$this->assertTrue( is_textdomain_loaded( 'bh-wc-zelle-gateway' ), 'i18n text domain not loaded.' );
	}
}
